...
Sch = pd.read_csv('https://raw.githubusercontent.com/walkerdj1995/spc-dash/master/WFMarGasSchedule.csv')
Dlo = pd.read_csv('https://raw.githubusercontent.com/walkerdj1995/spc-dash/master/Last_30_Days.csv')
